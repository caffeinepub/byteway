        ...
        <nav className="hidden md:flex items-center gap-6 ml-auto">
          ...
          {adminLinkVisible && (
            <div className="flex items-center gap-2 ml-2 animate-in fade-in duration-300">
              <Link
                to="/admin"
                className="flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full bg-indigo-500/10 text-indigo-400 border border-indigo-500/25 hover:bg-indigo-500/20 transition-colors"
              ...
              <Link
                to="/admin"
                className="flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full bg-cyan-500/10 text-cyan-400 border border-cyan-500/25 hover:bg-cyan-500/20 transition-colors"
